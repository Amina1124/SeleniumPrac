...
public class PracticeForm {
	...
	static void fillOutForm() throws Exception {
		...
		UsrInfo user1=Util.readInfoFromExcel(fpath+"\\src\\com\\selenium\\data\\usrInfo.xlsx");
...
//		System.out.println(driver.findElements(By.name("gender")).size());
		...
		List<WebElement> genderElem=driver.findElements(By.name("gender"));//find elements
//		int elemSize=driver.findElements(By.name("gender")).size();    
		...
		//"05/01/1997"	
		String[] dob=user1.getDOB().split("[/]");  //dob[0]=05  dob[1]=01   dob[2]=1997
		String monthName="";
...
//		sel_month.selectByValue("0");
		...
		List<WebElement> days=driver.findElements(By.xpath("//div[contains"
